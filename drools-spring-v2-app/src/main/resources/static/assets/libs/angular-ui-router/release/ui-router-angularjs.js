...
(function (global, factory) {
    ...
    var hasAnyKey = function (keys, obj) {
        return keys.reduce(function (acc, key) {
            return acc || _uirouter_core.isDefined(obj[key]);
        }, false);
    };
        ...
        if (_uirouter_core.isDefined(state.views) && hasAnyKey(allViewKeys, state)) {
            throw new Error("State '" + state.name + "' has a 'views' object. " +
                ...
                (" " + allViewKeys.filter(function (key) {
                    return _uirouter_core.isDefined(state[key]);
                }).join(", ")));
        }
    ...
    var Ng1ViewConfig = (function () {
        ...
        Ng1ViewConfig.prototype.load = function () {
            ...
            var params = this.path.reduce(function (acc, node) {
                return _uirouter_core.extend(acc, node.paramValues);
            }, {});
            var promises = {
    ...
    var TemplateFactory = (function () {
        ...
        TemplateFactory.prototype.fromConfig = function (config, params, context) {
            ...
            var asTemplate = function (result) {
                return _uirouter_core.services.$q.when(result).then(function (str) {
                    return ({template: str});
                });
            };
...
// for ng 1.3 through ng 1.5, process the component's bindToController: { input: "=foo" } object
    var scopeBindings = function (bindingsObj) {
        return Object.keys(bindingsObj || {})
            ...
            .filter(function (tuple) {
                return _uirouter_core.isDefined(tuple) && _uirouter_core.isArray(tuple[1]);
            })
            .map(function (tuple) {
    ...
    var Ng1LocationServices = (function () {
        ...
        Ng1LocationServices.prototype.onChange = function (callback) {
            ...
            return function () {
                return _uirouter_core.removeFrom(_this._urlListeners)(callback);
            };
        };
        ...
        UrlRouterProvider.prototype.otherwise = function (rule) {
            ...
            if (_uirouter_core.isString(rule)) {
                ...
                urlRouter.otherwise(function () {
                    return rule(_uirouter_core.services.$injector, _this._router.locationService);
                });
            }
            else {
     ...
     * });
        ...
        UrlRouterProvider.injectableHandler = function (router, handler) {
            return function (match) {
                return _uirouter_core.services.$injector.invoke(handler, null, {
                    $match: match,
...
// $urlRouter service and $urlRouterProvider
    var getStateProvider = function () {
        return _uirouter_core.extend(router.stateProvider, {
            $get: function () {
    ...
    function watchDigests($rootScope) {
        $rootScope.$watch(function () {
            _uirouter_core.trace.approximateDigests++;
        });
    }
            ...
            return {
                ...
                link: function (scope, element, attrs, uiSrefActive) {
                    ...
                    var watchDeregFns = inputAttrs.reduce(function (acc, attr) {
                        return (acc[attr] = _uirouter_core.noop, acc);
                    }, {});
                    ...
                    function ($scope, $element, $attrs) {
                        ...
                        function update() {
                            ...
                            var getClasses = function (stateList) {
                                ...
                                }).map(splitClasses).reduce(_uirouter_core.unnestR, []);
                            };
                            ...
                            var removeClasses = allClasses.filter(function (cls) {
                                return !_uirouter_core.inArray(addClasses, cls);
                            });
        ...
        return {
            ...
            compile: function (tElement) {
                ...
                return function (scope, $element) {
                    ...
                    if (controller) {
                        var controllerInstance = $controller(controller, _uirouter_core.extend({}, locals, {
                            $scope: scope,
                            $element: $element
                        }));
                        if (controllerAs) {
        ...
        if (_uirouter_core.isFunction(controllerInstance.uiOnParamsChanged)) {
            ...
            var paramsUpdated = function ($transition$) {
                ...
                if (changedToParams.length) {
                    ...
                    var newValues = _uirouter_core.filter(toParams, function (val$$1, key) {
